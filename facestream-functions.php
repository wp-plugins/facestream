...
define ( 'BP_FACESTREAM_VERSION', '1.0.1' );
...
function facestream_settings_screen_content() {
    ...
    if(get_usermeta ( $user_id, 'facestream_session_key' )){
		...
		<a href="http://www.facebook.com/login.php?api_key=<?php echo get_site_option('facestream_api_key');?>&display=popup&extern=1&fbconnect=1&req_perms=offline_access,read_stream,publish_stream,status_update&return_session=1&v=1.0&next=<?php echo $bp->root_domain;?>/?type=facebook&fb_connect=1&cancel_url=<?php echo $bp->root_domain;?>/?type=facebook"><input type="button" value="<?php echo __( 'Authorize with facebook', 'facestream_lang' );?>"></a><br/><br/>
